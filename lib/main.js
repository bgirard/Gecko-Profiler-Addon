...
if (!require("api-utils/xul-app").is("Thunderbird")) {
  ...
  try {
    // This will fail in FF 20 or later because of per-window-private-browsing
...
function EnableShutdownWatcher(profiler) {
  var want_feature_watchdog = prefs.get_pref_bool("profiler.", "watchdog", false);
...
function sps_startup(force, manifest) {
    ...
    // Watch dog info
    prefs.default_init_pref("profiler.", "watchdog", false); // This pref has privacy implication. Always off by default!
    ...
    timers.setTimeout(function() {
        ...
        if (profilerIsActive == false && savedProfileLastStop != null) {
            ...
            profiler.getProfile(function(profile) {
                ...
                if (screencast && screencast.isRecording()) {
    ...
    try {
      new ProfilerWrapper({}, function() {
        ...
        this.getFeatures(function(features) {
            ...
            profilerFeatures.push("watchdog");
