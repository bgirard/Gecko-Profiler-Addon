...
let FirefoxAppWrapper = {
  ...
  init: function ff_init() {
      ...
      panel.port.on("adbconnect", function(options) {
          ...
          prefs.set_pref_string("profiler.", "androidLibsHostPath", options.adbLibCache);
          remoteHostInstance.setAdbLibCache(options.adbLibCache);
            ...
            function cb() {
              remoteHostInstance.forwardPort(port,
                function cb() {
                    ...
                    panel.port.emit("show_adb_status", "Manually accept incoming connection");  
  ...
  get_profiler_status: function ff_profiler_status() {
      ...
      var adbLibCache = prefs.get_pref_string("profiler.", "androidLibsHostPath");
