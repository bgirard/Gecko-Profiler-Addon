                ...
                cmdRunnerModule.runCommand("/bin/bash -l -c 'adb shell run-as " + processInfo.pkgName + " kill -12 " + processInfo.pid + "'", function(r) {
                    adb_get_process_info( function (processInfo2) {
                        ...
                        var intervalId = timers.setInterval(function() {
                            ...
                            cmdRunnerModule.runCommand("/bin/bash -l -c 'adb pull /sdcard/profile_0_" + processInfo.pid + ".txt /tmp/fennec_profile.txt; adb pull /data/app/" + processInfo.pkgName + "-1.apk /tmp/symbol.apk || adb pull /data/app/" + processInfo.pkgName + "-2.apk /tmp/symbol.apk; unzip -o /tmp/symbol.apk -d /tmp'", function (r) {
