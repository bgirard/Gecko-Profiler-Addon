...
function sps_update_status() {
    ...
    panel.port.emit("change_status", {profilerFeatures: profilerFeatures, startedWithFeatures: startedWithFeatures, runningLabel: runningLabel, isActive: isActive});
    if (settingsTabPort)
      settingsTabPort.port.emit("change_status", {profilerFeatures: profilerFeatures, startedWithFeatures: startedWithFeatures, runningLabel: runningLabel, isActive: isActive});
}
