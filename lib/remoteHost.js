...
exports.HasPreReq = function(cb, error_cb) {
  ...
  cmdRunnerModule.runCommand("/bin/bash -l -c 'adb version 2>&1'", function (r) {
    if (r.indexOf("Android Debug Bridge") >= 0) {
      cmdRunnerModule.runCommand("/bin/bash -l -c 'which arm-linux-androideabi-addr2line'", function (r) {
        if (r.indexOf("/") == 0) {
          ...
          error_cb({
            description: "Please install the android NDK and place 'arm-linux-androideabi-addr2line' in your path. http://developer.android.com/tools/sdk/ndk/index.html",
